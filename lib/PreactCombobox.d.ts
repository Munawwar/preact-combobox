...
export type LabelTransformFunction = (label: VNode[], value: VNode[], match: OptionMatch, language: string, showValue: boolean) => VNode;
...
export type PreactComboboxProps = {
     ...
     */
    allowedOptions: Option[] | ((query: string, limit: number, currentSelections: string[], abortControllerSignal: AbortSignal) => Promise<Option[]>);
    /**
