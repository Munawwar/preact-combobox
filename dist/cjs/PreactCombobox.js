...
__export(PreactCombobox_exports, {
  ...
  subscribeToVirtualKeyboard: () => subscribeToVirtualKeyboard,
});
...
function mapToStyles(_ref2) {
  ...
  var _offsets$x = offsets.x,
    x3 = _offsets$x === void 0 ? 0 : _offsets$x,
  ...
  return Object.assign(
    ...
    commonStyles,
    ((_Object$assign2 = {}),
    (_Object$assign2[sideY] = hasY ? y3 + "px" : ""),
    (_Object$assign2[sideX] = hasX ? x3 + "px" : ""),
...
function M(n2) {
  ((!n2.__d && (n2.__d = true) && i.push(n2) && !P.__r++) || r !== l.debounceRendering) &&
...
function $(n2, l3, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  var a3,
    ...
    g4 = (t3 && t3.__k) || v,
    m3 = l3.length;
  for (f4 = I(u4, l3, g4, f4, m3), a3 = 0; a3 < m3; a3++)
    null != (y3 = u4.__k[a3]) &&
      ((h3 = -1 === y3.__i ? p : g4[y3.__i] || p),
      (y3.__i = a3),
      (_3 = j(n2, y3, h3, i4, r3, o3, e3, f4, c3, s3)),
      (d3 = y3.__e),
      y3.ref &&
        h3.ref != y3.ref &&
        (h3.ref && V(h3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)),
      null == w3 && null != d3 && (w3 = d3),
      4 & y3.__u || h3.__k === y3.__k
        ? (f4 = A(y3, f4, n2))
        : "function" == typeof y3.type && void 0 !== _3
          ? (f4 = _3)
          : d3 && (f4 = d3.nextSibling),
      (y3.__u &= -7));
  return (u4.__e = w3), f4;
}
  ...
  for (n2.__k = new Array(i4), r3 = 0; r3 < i4; r3++)
    null != (o3 = l3[r3]) && "boolean" != typeof o3 && "function" != typeof o3
      ? ((f4 = r3 + h3),
        ...
        (o3.__b = n2.__b + 1),
        (e3 = null),
        -1 !== (c3 = o3.__i = L(o3, u4, f4, a3)) && (a3--, (e3 = u4[c3]) && (e3.__u |= 2)),
        null == e3 || null === e3.__v
          ? (-1 == c3 && h3--, "function" != typeof o3.type && (o3.__u |= 4))
          : c3 != f4 &&
...
function A(n2, l3, u4) {
  ...
  n2.__e != l3 &&
    (l3 && n2.type && !u4.contains(l3) && (l3 = C(n2)),
...
function T(n2, l3, u4) {
  "-" == l3[0]
    ...
    : (n2[l3] = null == u4 ? "" : "number" != typeof u4 || y.test(l3) ? u4 : u4 + "px");
}
  ...
  n: if ("function" == typeof F4)
    try {
      if (
        ...
        (S2 = (a3 = F4.contextType) && i4[a3.__c]),
        (M2 = a3 ? (S2 ? S2.props.value : a3.__) : i4),
        t3.__c
          ? (m3 = (h3 = u4.__c = t3.__c).__ = h3.__E)
          : (C3
              ? (u4.__c = h3 = new F4(b2, M2))
              : ((u4.__c = h3 = new x(b2, M2)), (h3.constructor = F4), (h3.render = B)),
            S2 && S2.sub(h3),
            (h3.props = b2),
            h3.state || (h3.state = {}),
            (h3.context = M2),
            ...
            (h3.__h = []),
            (h3._sb = [])),
        C3 && null == h3.__s && (h3.__s = h3.state),
        C3 &&
          null != F4.getDerivedStateFromProps &&
          (h3.__s == h3.state && (h3.__s = w({}, h3.__s)),
          w(h3.__s, F4.getDerivedStateFromProps(b2, h3.__s))),
        (v3 = h3.props),
        (y3 = h3.state),
        (h3.__v = u4),
        p3)
        ...
        C3 &&
          ...
          C3 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
      else {
        if (
          (C3 &&
            null == F4.getDerivedStateFromProps &&
          ...
          for (
            u4.__v != t3.__v && ((h3.props = b2), (h3.state = h3.__s), (h3.__d = false)),
              u4.__e = t3.__e,
              u4.__k = t3.__k,
        ...
        null != h3.componentWillUpdate && h3.componentWillUpdate(b2, h3.__s, M2),
          C3 &&
      ...
      (h3.state = h3.__s),
        null != h3.getChildContext && (i4 = w(w({}, i4), h3.getChildContext())),
        C3 &&
          !p3 &&
          null != h3.getSnapshotBeforeUpdate &&
          (g4 = h3.getSnapshotBeforeUpdate(v3, y3)),
        (f4 = $(
          n2,
          d((L2 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3))
            ? L2
            : [L2],
          u4,
          t3,
    ...
    null == o3 && u4.__v == t3.__v
      ...
      : (f4 = u4.__e = N(t3.__e, u4, t3, i4, r3, o3, e3, c3, s3));
...
function N(u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  ...
  if (
    ...
    for (a3 = 0; a3 < e3.length; a3++)
      if (
        (w3 = e3[a3]) &&
        "setAttribute" in w3 == !!x3 &&
        (x3 ? w3.localName == x3 : 3 == w3.nodeType)
      ) {
        (u4 = w3), (e3[a3] = null);
        break;
      }
        ...
        "children" == a3
          ...
          : "dangerouslySetInnerHTML" == a3
            ...
            : "value" == a3
              ...
              : "checked" == a3
                ? (m3 = w3)
                : (c3 && "function" != typeof w3) || b2[a3] === w3 || F(u4, a3, w3, b2[a3], o3);
    if (h3)
      c3 ||
      ...
      $(
        ...
        e3,
        f4,
        e3 ? e3[0] : i4.__k && C(i4, 0),
        c3,
        s3,
      ),
      null != e3)
    )
      for (a3 = e3.length; a3--; ) _(e3[a3]);
    c3 ||
      ((a3 = "value"),
      "progress" == x3 && null == g4
        ? u4.removeAttribute("value")
        : void 0 !== g4 &&
          (g4 !== u4[a3] || ("progress" == x3 && !g4) || ("option" == x3 && g4 !== b2[a3])) &&
          F(u4, a3, g4, b2[a3], o3),
      (a3 = "checked"),
      void 0 !== m3 && m3 !== u4[a3] && F(u4, a3, m3, b2[a3], o3));
  }
  return u4;
}
function V(n2, u4, t3) {
...
function q(n2, u4, t3) {
  ...
  if (
    ...
    (i4 = n2.ref) && ((i4.current && i4.current !== n2.__e) || V(i4, null, u4)),
    null != (i4 = n2.__c))
  ) {
  ...
  if ((i4 = n2.__k))
    for (r3 = 0; r3 < i4.length; r3++) i4[r3] && q(i4[r3], u4, t3 || "function" != typeof n2.type);
...
function D(u4, t3, i4) {
  ...
  t3 == document && (t3 = document.documentElement),
    ...
    j(
      t3,
      (u4 = ((!r3 && i4) || t3).__k = g(k, null, [u4])),
      o3 || p,
      p,
      t3.namespaceURI,
      !r3 && i4 ? [i4] : o3 ? null : t3.firstChild ? n.call(t3.childNodes) : null,
      e3,
...
(n = v.slice),
        ...
        if ((i4 = l3.__c) && !i4.__)
          try {
            if (
              ...
              null != i4.componentDidCatch && (i4.componentDidCatch(n2, t3 || {}), (o3 = i4.__d)),
              o3)
            )
              return (i4.__E = i4);
          } catch (l4) {
  ...
  (x.prototype.setState = function (n2, l3) {
    var u4;
    (u4 = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = w({}, this.state))),
      "function" == typeof n2 && (n2 = n2(w({}, u4), this.props)),
      n2 && w(u4, n2),
  ...
  return (
    n2 &&
      (n2.__c &&
        ...
        (n2.__c.__H = null)),
      null != (n2 = g3({}, n2)).__c && (n2.__c.__P === e3 && (n2.__c.__P = t3), (n2.__c = null)),
      (n2.__k =
        n2.__k &&
...
function W(n2, t3, e3) {
  return (
    n2 &&
      ...
      n2.__c &&
        n2.__c.__P === t3 &&
        (n2.__e && e3.appendChild(n2.__e), (n2.__c.__e = true), (n2.__c.__P = e3))),
    n2
  );
}
function P3() {
...
(x.prototype.isReactComponent = {}),
  ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function (t3) {
  ...
  "string" == typeof n2.type &&
    (function (n3) {
      ...
      for (var i4 in t3) {
        ...
        if (
          !(
            ("value" === i4 && "defaultValue" in t3 && null == c3) ||
            (Q && "children" === i4 && "noscript" === e3) ||
            "class" === i4 ||
            "className" === i4
          )
        ) {
            ...
            : "download" === i4 && true === c3
              ...
              : "translate" === l3 && "no" === c3
                ...
                : "o" === l3[0] && "n" === l3[1]
                  ? "ondoubleclick" === l3
                    ? (i4 = "ondblclick")
                    : "onchange" !== l3 || ("input" !== e3 && "textarea" !== e3) || X(t3.type)
                      ? "onfocus" === l3
                        ? (i4 = "onfocusin")
                        : "onblur" === l3
                          ? (i4 = "onfocusout")
                      ...
                      : (l3 = i4 = "oninput")
                  : o3 && G2.test(i4)
                    ? (i4 = i4.replace(K, "-$&").toLowerCase())
                    : null === c3 && (c3 = void 0),
            "oninput" === l3 && u4[(i4 = l3)] && (i4 = "oninputCapture"),
            (u4[i4] = c3);
        }
      }
      "select" == e3 &&
        ...
        t3.class && !t3.className
          ? ((u4.class = t3.class), Object.defineProperty(u4, "className", ln))
...
function isEqual(value1, value2) {
  ...
  function deepCompare(a3, b2) {
    ...
    if (
      a3.$$typeof === Symbol.for("react.element") ||
      b2.$$typeof === Symbol.for("react.element")
    ) {
      return a3 === b2;
    }
...
function matchSlicesToNodes(matchSlices, text) {
  ...
  matchSlices.map((slice) => {
    ...
    if (index < start2) {
      nodes.push(
        /* @__PURE__ */ u3("span", { children: text.slice(index, start2) }, `${index}-${start2}`),
      );
    }
    nodes.push(
      /* @__PURE__ */ u3("u", { children: text.slice(start2, end2) }, `${start2}-${end2}`),
    );
    index = end2;
  });
  if (index < text.length) {
    nodes.push(
      /* @__PURE__ */ u3("span", { children: text.slice(index) }, `${index}-${text.length}`),
    );
  }
  return nodes;
}
var defaultWarningIcon = /* @__PURE__ */ u3("svg", {
...
var defaultChevronIcon = /* @__PURE__ */ u3("svg", {
  ...
  const getLabel = (labelNodes, valueNodes) =>
    /* @__PURE__ */ u3(k, {
      children: [
        ...
        /* @__PURE__ */ u3("span", {
          className: "PreactCombobox-optionLabelFlex",
          children: [
            /* @__PURE__ */ u3("span", { children: labelNodes }),
            isLabelSameAsValue || !showValue
              ? null
              : /* @__PURE__ */ u3("span", {
                  className: "PreactCombobox-optionValue",
                  "aria-hidden": "true",
                  children: ["(", valueNodes, ")"],
                }),
          ],
  ...
  return /* @__PURE__ */ u3(k, {
    children: [
      /* @__PURE__ */ u3("span", {
        ...
        children:
          isSelected && /* @__PURE__ */ u3("span", { "aria-hidden": "true", children: "\u2713" }),
      }),
      labelElement,
...
function defaultOptionIconRenderer(option) {
  return option.icon
    ? /* @__PURE__ */ u3("span", {
        className: "PreactCombobox-optionIcon",
        "aria-hidden": "true",
        role: "img",
...
var PreactCombobox = ({
  ...
  const values = multiple
    ? /** @type {string[]} */
      value
    : null;
  const singleSelectValue = multiple
    ? null
    : /** @type {string} */
      value;
  let tempArrayValue;
      ...
      if (typeof allowedOptions === "function") {
        ...
        if (!inputTrimmed) {
          const unreturnedValues = newUnknownValues
            .filter((v3) => !cachedOptions.current[v3])
            .map((v3) => ({ label: v3, value: v3 }));
  ...
  const addNewOptionVisible =
    ...
    !filteredOptions.find((o3) => o3.value === inputTrimmed);
  y2(() => {
  ...
  const handleAddNewOption = q2(
    ...
    (newValue) => {
      ...
      if (!filteredOptions.find((o3) => o3.value === newValue)) {
    ...
    (e3) => {
      ...
      if (e3.key === "Enter") {
        ...
        const currentIndex = currentActiveDescendant
          ? filteredOptions.findIndex((o3) => o3.value === currentActiveDescendant)
          : -1;
        if (currentIndex > -1) {
          const option =
            /** @type {OptionMatch} */
    ...
    (e3) => {
      ...
      const pastedOptions = pastedText
        ...
        .map(
          (x3) =>
            valuesLookup[x3] ||
            valuesLowerCaseLookup[x3.toLowerCase()] ||
            optionsLabelLookup[x3.toLocaleLowerCase()] ||
            x3,
        );
      ...
      formSubmitCompatible
        ? arrayValues
            .map((val) =>
              /* @__PURE__ */ u3(
                "option",
                { value: val, children: allOptionsLookup[val]?.label || val },
                val,
              ),
            )
            .concat(
              typeof allowedOptions !== "function"
                ? allowedOptions
                    .filter((o3) => !arrayValuesLookup.has(o3.value))
                    .slice(0, maxNumberOfPresentedOptions - arrayValues.length)
                    .map((o3) =>
                      /* @__PURE__ */ u3(
                        "option",
                        { value: o3.value, children: o3.label },
                        o3.value,
                      ),
                    )
                : [],
  ...
  return /* @__PURE__ */ u3("div", {
    ...
    children: [
      /* @__PURE__ */ u3("div", {
        ...
        "aria-live": "polite",
        "aria-atomic": "true",
        children: getIsFocused() ? lastSelectionAnnouncement : "",
      }),
      /* @__PURE__ */ u3("div", {
        className: "PreactCombobox-srOnly",
        "aria-live": "polite",
        "aria-atomic": "true",
        children: getIsFocused() ? loadingAnnouncement : "",
      }),
      /* @__PURE__ */ u3("div", {
        className: "PreactCombobox-srOnly",
        "aria-live": "polite",
      ...
      /* @__PURE__ */ u3("div", {
        className: `PreactCombobox-field ${disabled ? "PreactCombobox-field--disabled" : ""}`,
        children: [
          !isServerSideForm &&
            /* @__PURE__ */ u3(k, {
              children: [
                ...
                /* @__PURE__ */ u3("input", {
                  ...
                  type: "text",
                  value: inputValue,
                  placeholder: getIsDropdownOpen()
                    ? mergedTranslations.searchPlaceholder
                    : arrayValues.length > 0
                      ? arrayValues
                          .map((value2) => allOptionsLookup[value2]?.label || value2)
                          .join(", ")
                      : placeholder,
                ...
                multiple &&
                  ...
                  /* @__PURE__ */ u3("span", {
                    className: "PreactCombobox-badge",
                    children: mergedTranslations.selectedCountFormatter(
                      arrayValues.length,
                      language,
                    ),
                  }),
          ...
          children: /* @__PURE__ */ u3("ul", {
            ...
            children: isLoading
              ? /* @__PURE__ */ u3("li", {
                  ...
                  "aria-disabled": true,
                  children: loadingRenderer(mergedTranslations.loadingOptions),
                })
              : /* @__PURE__ */ u3(k, {
                  children: [
                    addNewOptionVisible &&
                    ...
                    filteredOptions.length === 0 &&
                      ...
                      /* @__PURE__ */ u3("li", {
                        className: "PreactCombobox-option",
                        children: mergedTranslations.noOptionsFound,
                      }),
                    filteredOptions.length === maxNumberOfPresentedOptions &&
                      /* @__PURE__ */ u3("li", {
                        className: "PreactCombobox-option",
                        children: mergedTranslations.typeToLoadMore,
                      }),
                  ],
                }),
          }),
      ...
      invalidValues.length > 0 &&
        ...
        /* @__PURE__ */ u3(Portal, {
          ...
          children: /* @__PURE__ */ u3("div", {
            className: "PreactCombobox-valueTooltip",
            role: "tooltip",
            ref: tooltipPopperRef,
            children: [
              mergedTranslations.invalidValues,
              invalidValues.map((value2) =>
                /* @__PURE__ */ u3(
                  "div",
                  { className: "PreactCombobox-tooltipValue", children: value2 },
                  value2,
                ),
              ),
            ],
