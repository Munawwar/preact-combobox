...
var PreactCombobox = ({
  ...
  const handleKeyDown = q2(
    ...
    (e3) => {
      ...
      if (e3.key === "Enter") {
        ...
        dropdownClosedExplicitlyRef.current = false;
        if (!filteredOptions.length && !addNewOptionVisible) return;
        const currentIndex = currentActiveDescendant ? filteredOptions.findIndex((o3) => o3.value === currentActiveDescendant) : 0;
  ...
  const selectChildren = T2(
    () => formSubmitCompatible ? arrayValues.map((val) => /* @__PURE__ */ u3("option", { value: val, children: allOptionsLookup[val]?.label || val }, val)) : null,
  ...
  return /* @__PURE__ */ u3(
    "div",
    {
      ...
      children: [
        ...
        !isServerSideForm && /* @__PURE__ */ u3(Portal, { parent: portal, rootElementRef, children: /* @__PURE__ */ u3(
          "ul",
          {
        ...
        invalidValues.length > 0 && warningIconHovered && !isServerSideForm && /* @__PURE__ */ u3(Portal, { parent: portal, rootElementRef, children: /* @__PURE__ */ u3("div", { className: "PreactCombobox-valueTooltip", role: "tooltip", ref: tooltipPopperRef, children: [
